...
//		Smajli 10 | Like 15 | Srce 2
		...
		Reakcija reaction = new Reakcija("Srce", "N M");
		Reakcija reaction1 = new Reakcija("Smile", "N M");
		Reakcija reaction2 = new Reakcija("Like", "N M");
		
//		FacebookPost post1 = new FacebookPost("Nevena Grujic", ":)");	
